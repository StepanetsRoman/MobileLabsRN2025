...
const photoGallery = [
  require("./assets/Собака1.jpg"),
  require("./assets/Собака2.jpg"),
  require("./assets/Собака3.jpg"),
  require("./assets/Собака4.jpg"),
  require("./assets/Собака5.jpg"),
  require("./assets/Собака6.jpg"),
  require("./assets/Собака7.jpg"),
  require("./assets/Собака8.jpg"),
  require("./assets/Собака9.jpg"),
  require("./assets/Собака10.jpg"),
];
  ...
  render() {
    return (
      <View style={styles.footer}>
        <Text style={styles.footerText}>Степанець Роман Степанович, ВТк-24-1</Text>
      </View>
    );
  }
}
